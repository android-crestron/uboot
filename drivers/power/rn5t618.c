...
int rn5t618_init(void)
{
    ...
    // edtsai, 2015.01.16
    uint8_t testVal[10] = {};
    rn5t618_reads(0x0030, testVal, 10);
    printf("\n>>> DCDC3 default value:30h:%02x 31h:%02x 38h:%02x\n", 
        testVal[0], testVal[1], testVal[8] );

    // edtsai, 2015.01.22
    /*rn5t618_write(0x0038, 0x30); // 0x30 is a random value, for testing
    memset( testVal, 0, sizeof(testVal) );
    rn5t618_reads(0x0038, testVal, 1);
    printf("\n>>> 38h:%02x\n", testVal[0] );*/

    rn5t618_write(0x0038, 0x3C); // it's 1.35V
    memset( testVal, 0, sizeof(testVal) );
    rn5t618_reads(0x0038, testVal, 1);
    printf("\n>>> 38h:%02x\n", testVal[0] );
    ...
    memset( testVal, 0, sizeof(testVal) );
    rn5t618_reads(0x0030, testVal, 10);
    printf("\n>>> DCDC3 modified value:30h:%02x 31h:%02x 38h:%02x\n", 
        testVal[0], testVal[1], testVal[8] );
